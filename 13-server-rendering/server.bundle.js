	...
	app.get('*', function (req, res) {
	    (0, _reactRouter.match)({
	        ...
	        if (err) {
	            ...
	            res.send(renderPage((0, _server.renderToString)(_react2.default.createElement(_reactRouter.RouterContext, props))));
	        } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _My404Component = __webpack_require__(14);
	...
	exports.default = _react2.default.createElement(
	    ...
	    _react2.default.createElement(_reactRouter.Route, { path: '/404', component: _My404Component2.default }),
